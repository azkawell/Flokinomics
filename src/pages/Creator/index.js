...
function AuthorPage() {
  ...
  const getMyAll = async (isNew = false) => {
    ...
    for (let i = 0; i < res.hits.length; i++) {
      let doc = res.hits[i];
      const nftInfo = await getTokenInfo(doc.tokenURI);
      const nft_data =
        nftInfo !== undefined && nftInfo !== null
          ? { id: doc.objectID, ...user, ...doc, ...nftInfo }
  ...
  return (
    <main className="main">
      <div className="main__author authorImageWrapper" data-bg="assets/img/bg/bg.png">
      ...
      <div className="container">
        <div className="row row--grid">
          ...
          <div className="col-12 col-xl-9">
            <div className="profile bleuFrosted">
              {/* tabs nav */}
              <ul
            ...
            <div className="col-12 mt-3">
              <div className="search-outline-author d-flex ml-auto justify-content-end align-items-center">
                <input
                  type="text"
                  placeholder="Search..."
            ...
            <div className="tab-content">
              ...
              >
                <div className="row row--grid">
                  {/* details form */}
                  <div className="col-12">
                    <form action="#" className="sign__form sign__form--profile bleuFrosted">
                      <div className="row" style={{width: '102%'}}>
                        <div className="col-12 sign__cover authorImageWrapper h-200">
                          <img
                            src={
                        ...
                        <div className="col-12 col-lg-8">
                          <div className="sign__group">
                            ...
                            <input
                              ...
                              name="twitter"
                              className="sign__input"
                              placeholder="https://twitter.com/joindoe"
                              value={twitter || ""}
                              onChange={(e) => {
                        ...
                        <div className="col-12 col-lg-8">
                          <div className="sign__group">
                            ...
                            <input
                              ...
                              name="telegram"
                              className="sign__input"
                              placeholder="https://t.me/joindoe"
                              value={telegram || ""}
                              onChange={(e) => {
                        ...
                        <div className="col-12 col-lg-8">
                          <div className="sign__group">
                            ...
                            <input
                              ...
                              name="instagram"
                              className="sign__input"
                              placeholder="https://instagram.com/joindoe"
                              value={instagram || ""}
                              onChange={(e) => {
