  ...
  const dispatchUser = async (user_id) => {
    if (user_id) {
      ...
      if (userInfo) {
        ...
        history.push('/creator/' + account + '?tab=setting')
      }
    }
  };
    ...
    <header className="header">
      <div className="header__content">
        <div className="header__logo">
          ...
          <div className="search-outline d-flex justify-content-center align-items-center ml-5 navbarSearch">
            <input
            type="text"
            placeholder="Search..."
        ...
        <div className="header__actions">
          ...
          {active ? (
            <div className="header__action header__action--profile">
              ...
              <ul
                className="dropdown-menu header__profile-menu bleuFrosted"
