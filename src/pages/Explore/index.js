    ...
    <main className="main">
      <div className="container p-0">
        ...
        <div className="row explorerPanel">
          ...
          {/* Filter Sidebar */}
          <div className="col-12 col-xl-3 exploreFilter bleuFrosted d-none" >
          ...
          <div className="col-12 my-4 explorerRight">
            ...
            <div className="row row--grid relative">
              {cards.map((card, index) => (
                <div className="productGridItem col-6 col-sm-6 col-md-4 col-lg-3 " key={index}>
