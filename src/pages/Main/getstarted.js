      ...
      <div className="row row--grid mb-50">
        ...
        <div className="col-12 col-md-6 col-lg-4 " data-aos-delay="900" data-aos="fade-right">
          <div className="feature bleuFrosted p-4 getStartedPanelMargin200">
            ...
            <p className="feature__text">
            You decide what you want to upload. BleuFi supports images, audio and video. You can be as creative as you want to. Minting is free of charge so start creating your NFTs now and list them with one click.+
            </p>
          </div>
        </div>
      </div>
